...
$string['config_openstack_use_backup_server'] = 'Backup server';
$string['config_openstack_use_backup_server_description'] = 'Use a static server (bigbluebuttonbn_server_url) as a backup when dinamic BBB server failed';
$string['config_openstack_backup_recording'] = 'Backup server for recording';
$string['config_openstack_backup_recording_description'] = 'Use a static server (bigbluebuttonbn_server_url) as playback server for recordings. Shared storage must be appropriately configured';
$string['config_openstack_name_prefix'] = 'BBB servers prefix';
$string['config_openstack_name_prefix_description'] = 'Prefix for naming BBB servers';
$string['config_openstack_backup_settings'] = 'Static BBB backup server';