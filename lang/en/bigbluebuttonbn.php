...
$string['config_yaml_stack_template']='Heat Template';
$string['config_yaml_stack_template_description']='URL of file with the Heat template in YAML format.';
$string['config_json_stack_parameters']='Stack parameters';
$string['config_json_stack_parameters_description']='URL of file with arguments for Heat template, used for stack creation. They must be in JSON format.';
