...
$string['openstack_error_conection_message']='Failed to establish connection with the orchestration service of OpenStack. A record has been inserted in OpenStack Logs Table with ID={$a->log_id}. {$a->number_upcoming_conferences} meetings could be affected in the next 24 hours. Following is the list of meetings that could be affected soon: {$a->meetings_urls}<br /><br />This is the related error message:<br /><br /> {$a->error_message}.';
