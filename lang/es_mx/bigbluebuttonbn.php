...
$string['config_yaml_stack_template']='Plantilla de Heat';
$string['config_yaml_stack_template_description']='URL del archivo con la plantilla de Heat en formato YAML.';
$string['config_json_stack_parameters']='Parámetros del Stack';
$string['config_json_stack_parameters_description']='URL del archivo con lo parámetros para la plantilla de Heat, usada en la creación del stack. Deben estar en formato JSON.';
