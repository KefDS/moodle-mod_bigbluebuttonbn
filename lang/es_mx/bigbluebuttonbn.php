...
$string['config_openstack_use_backup_server'] = 'Tener servidor backup';
$string['config_openstack_use_backup_server_description'] = 'Usar el servidor estático (bigbluebuttonbn_server_url) como backup cuando no se puede generar un nuevo servidor dinámico';
$string['config_openstack_backup_recording'] = 'Servidor backup para grabaciones';
$string['config_openstack_backup_recording_description'] = 'Usar el servidor estático (bigbluebuttonbn_server_url) para mostrar las grabaciones. Debe estar configurado apropiadamente el almacenamiento compartido';
$string['config_openstack_name_prefix'] = 'Prefijo a servidores BBB';
$string['config_openstack_name_prefix_description'] = 'Prefijo para nombre de servidores BBB';
$string['config_openstack_backup_settings'] = 'Servidor estático BBB de respaldo';